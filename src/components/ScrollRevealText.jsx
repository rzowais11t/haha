...
export default function ScrollRevealText() {
  ...
  const getWordStyle = (index, totalWords, rangeStart, rangeEnd) => {
    ...
    // Glowing luminescence during the active transition window
    const glowIntensity = Math.sin(wordProgress * Math.PI);
  ...
  return (
    <section
      ref={containerRef}
      className="relative h-[220vh] sm:h-[250vh] bg-bg z-[2] border-t border-border"
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col justify-center px-6 min-[900px]:px-12 overflow-hidden">
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="w-[600px] h-[600px] max-w-full rounded-full bg-gradient-to-br from-white/[0.035] via-white/[0.015] to-transparent blur-3xl" />
        </div>
