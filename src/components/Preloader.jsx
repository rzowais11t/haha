  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-10 sm:gap-12 px-6 pointer-events-auto">
        ...
        {!showPrompt && (
          <div className="w-[280px] sm:w-[320px] opacity-0 animate-fade-in flex flex-col items-center">
            <div className="w-full flex justify-between font-space text-[0.75rem] text-muted tracking-[0.2em] mb-3">
              <span>SYS.INIT_</span>
            ...
            <div className="w-full h-[1px] bg-white/15 relative">
              <div
                className="absolute top-0 left-0 h-full bg-white transition-[width] duration-150 ease-out"
                style={{
                  width: `${progress}%`,
        ...
        {showPrompt && (
          <div className="w-full max-w-[360px] flex flex-col items-center gap-3.5 animate-preloader-enter">
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-3.5 rounded-full border border-white/40 bg-white/[0.12] hover:bg-white/[0.22] hover:border-white text-white font-space text-[0.75rem] tracking-[0.2em] uppercase transition-all duration-300 shadow-[0_0_25px_rgba(255,255,255,0.12)] cursor-pointer group hover:scale-[1.02] active:scale-[0.98]"
            >
              {/* Audio wave icon */}
              <svg
