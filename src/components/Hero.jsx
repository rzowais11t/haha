...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-between px-6 min-[900px]:px-12 overflow-hidden border-t-0 py-0 z-[2]">
      ...
      <h1 className="relative z-[2] font-space font-bold text-[clamp(4rem,12vw,11rem)] leading-[0.92] tracking-[-0.03em] pt-[6rem] min-[500px]:pt-[8rem] [text-shadow:0_2px_20px_rgba(0,0,0,0.8)] max-[500px]:text-[3.2rem] reveal">
        Embrace<br />
        {currentText}
      ...
      <div className="relative z-[2] pb-12 grid grid-cols-1 min-[900px]:grid-cols-2 gap-8">
        <div></div>
        <p className="text-[clamp(1.2rem,2.5vw,1.75rem)] leading-[1.45] max-w-[620px] ml-0 min-[900px]:ml-auto font-normal [text-shadow:0_2px_10px_rgba(0,0,0,0.8)] reveal">
