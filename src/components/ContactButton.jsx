...
export default function ContactButton({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-14 h-14 md:w-20 md:h-20 rounded-full border-[3px] border-text flex items-center justify-center transition-all duration-500 group-hover:scale-110 shadow-[0_0_30px_rgba(255,255,255,0)] flex-shrink-0 ml-4">
